...
<body class="skin-yellow-light">
  ...
  <section class="content">
    <div class="box">
      ...
      <div class="box-footer clearfix">
        <div class="pull-left">
        <span id="add" class="btn btn-default btn-sm" data-placement="top"><i class="fa fa-plus"></i>&nbsp;&nbsp;添加</span>
          <span id="deleteAll" class="btn btn-danger btn-sm" data-placement="top">批量删除</span>
  ...
  <script type="text/javascript">
    seajs.use('/edu/Public/js/admin/fileGroup/index.js')
  </script>
