...
<body class="skin-yellow-light">
  ...
  <section class="content">
    <div class="box">
      ...
      <div class="box-body">
        <table class="table table-bordered table-hover v-center">
          ...
          <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td class="text-center"><?php echo ($vo["serializemode"]); ?></td>
            <td class="text-center hidden-xs"><?php echo ($vo["studentnum"]); ?></td>
            <td class="text-center hidden-xs"><?php echo ($vo["statustext"]); ?></td>
            <td class="text-center hidden-xs"><?php echo ($vo["createduser"]); ?></td>
            <td class="text-center">
              <div class="btn-group btn-group-sm">
                <button type="button" class="btn btn-warning" data-toggle="modal" data-target="#modal" data-url="<?php echo U('Admin/Course/edit', array('course_id' => $vo['id']));?>">编辑课程</button>
      ...
      <div class="box-footer clearfix">
        <div class="pull-left">
          <span class="btn btn-default btn-sm" data-toggle="modal" data-target="#modal" data-url="<?php echo U('Admin/Course/add');?>"><i class="fa fa-plus"></i> 添加课程</span>
  ...
  <script type="text/javascript">
    seajs.use('/edu/Public/js/admin/Course/index.js')
  </script>
