<?php if (!defined('THINK_PATH')) exit();?><div class="modal-dialog modal-lg">
  <div class="modal-content">
    <form class="form-horizontal lesson-form" id="course-lesson-form" method="post" novalidate="novalidate" action="<?php echo U('Admin/CourseLesson/addLesson');?>">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-9 controls">
            <input id="title" name="title" required="required" class="form-control" type="text">
            <div class="help-block"></div>
          </div>
        </div>
        ...
        <div class="form-group for-text-type">
          ...
          <div class="col-md-9 controls">
            <textarea class="form-control" id="lesson-content-field" name="content" data-image-upload-url="" data-flash-upload-url=""></textarea>
          <div class="help-block"></div>
          </div>
        </div>
        ...
        <div class="form-group for-video-type">
          ...
          <div class="col-sm-9 controls">
            <div id="media-choosers">
                  ...
                  <div class="tab-content">
                    ...
                    <div class="tab-pane" id="tab_2">
                      <div id="file-browser" class="file-browser">
                        ...
                        <?php else: ?>
                          <?php if(is_array($materialList)): $i = 0; $__LIST__ = $materialList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$material): $mod = ($i % 2 );++$i;?><div class="item" data-file-id="<?php echo ($material["fileid"]); ?>" data-file-title="<?php echo ($material["title"]); ?>"><?php echo ($material["title"]); ?></div><?php endforeach; endif; else: echo "" ;endif; endif; ?>
                      </div>
                    </div>
                    <!-- /.tab-pane -->
                  </div>
              ...
              <input name="media_name" type="hidden" />
              <input name="media_uri" type="hidden" />
