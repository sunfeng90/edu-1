  ...
  <section class="section-course-list">
    <div class="container">
      <div class="course-list">
        ...
        <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$course): $mod = ($i % 2 );++$i;?><div class="col-lg-3 col-md-4 col-sm-6">
            <div class="course-item">
              ...
              <div class="course-info">
                <div class="title">
                  <a class="link-dark" href="/course/4" target="_blank"><?php echo ($course["title"]); ?></a>
                </div>
