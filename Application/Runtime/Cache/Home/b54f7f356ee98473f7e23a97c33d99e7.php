          ...
          <span class="icon-bar"></span>
            ...
            <div class="collapse navbar-collapse" id="navbar-collapse">
                <ul class="nav navbar-nav">
                    <li><a href="/edu/Home/Course" style="color: aliceblue;">课程</a></li>
                    <li><a href="/edu/Home/CourseTopic" style="color: aliceblue;">话题</a></li>
                    <li><a href="/edu/Home/Index/about" style="color: aliceblue;">关于我们</a></li>
                </ul>
                <ul class="nav user-nav">
                    <?php if(empty($user)): ?><li class="hidden-xs"><a href="/edu/Admin/Login/index?goto=/edu/Home/Index/index" style="color: aliceblue;">登录</a></li>
                        <li class="hidden-xs"><a href="/edu/Admin/Register/index?goto=/edu/Home/Index/index" style="color: aliceblue;">注册</a></li>
                        <?php else: ?>
                        <li class="user-avatar-li dropdown nav-hover">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                ...
                                <li><a href="/Admin/Login/logout?goto=/edu/Home/Index/index"><i class="fa fa-power-off"></i> 退出登录</a></li>
                            </ul>
                        </li><?php endif; ?>
                </ul>
